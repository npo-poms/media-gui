angular.module( 'poms.media.directives' )
    .directive( 'pomsGenres', [
        'PomsEvents',
        'EditService', 'FavoritesService' ,'MediaService', 'ListService', '$q', '$sce', '$timeout',
        '$uibModal', 'EditFieldService',
        function ( pomsEvents, editService, favoritesService, mediaService, listService, $q, $sce, $timeout, $uibModal, editFieldService ) {
            return {
                restrict: 'E',
                ...
                controller: function ( $scope ) {
                    ...
                    $scope.showEditElement = function ( ) {
                        if ( $scope.mayWrite() && !$scope.isOpen ) {
                            mediaService.getGenres($scope.media ).then(
                                function ( data ) {
