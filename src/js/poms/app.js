            ...
            return editableDirectiveFactory({
                ...
                render: function() {
                    ...
                    var html = '<label ng-repeat="'+parsed.ngRepeat+'">'+
                        ...
                        '<span class="list-icon" ng-class="'+ parsed.locals.displayFn +'"  ng-bind="'+parsed.locals.displayFn+'"></span></label>';
            ...
            return editableDirectiveFactory({
                ...
                render: function() {
                    ...
                    var html = '<label ng-repeat="'+parsed.ngRepeat+'">'+
                        ...
                        '<span class="list-icon" ng-class="'+ parsed.locals.valueFn +'"  ng-bind="'+parsed.locals.displayFn+'"></span></label>';
                    this.inputEl.removeAttr('ng-model');
                    this.inputEl.removeAttr('ng-options');
                    this.inputEl.html(html);
                },
